...
AMinedakiPlayer::AMinedakiPlayer()
{
    ...
    GetCapsuleComponent()->InitCapsuleSize(34,88); bUseControllerRotationYaw=false;
    ...
    Body->SetStaticMesh(Sphere.Object); Body->SetMaterial(0,Material.Object); Body->SetRelativeScale3D(FVector(.7,.7,1.65));
...
void AMinedakiPlayer::SetupPlayerInputComponent(UInputComponent* Input)
{
    ...
    Input->BindAxis(TEXT("Turn"),this,&AMinedakiPlayer::Turn); Input->BindAxis(TEXT("LookUp"),this,&AMinedakiPlayer::Look);
    Input->BindAxis(TEXT("TurnRate"),this,&AMinedakiPlayer::TurnRate); Input->BindAxis(TEXT("LookUpRate"),this,&AMinedakiPlayer::LookRate);
...
void AMinedakiPlayer::Tick(float Dt)
{
    ...
    if(Progress>=1) { Node=Destination; Destination=INDEX_NONE; RouteDelay=.22f; Boss->NotifyRouteNode(Node); }
}
...
void AMinedakiPlayer::CalcCamera(float Dt,FMinimalViewInfo& View)
{
    ...
    FHitResult Hit; FCollisionQueryParams Params(SCENE_QUERY_STAT(MinedakiCamera),false,this);
